...
seqIVT={
    struct('name','carDark','path','D:\workspace\rl\DRLT\OTB100\OTB100\CarDark\img\','startFrame',1,'endFrame',393,'nz',4,'ext','jpg','init_rect', [0,0,0,0]),...
...
%     struct('name','girl','path','d:\data_seq\girl\','startFrame',1,'endFrame',500,'nz',4,'ext','jpg','init_rect', [0,0,0,0]),...
    struct('name','walking2','path','D:\workspace\rl\DRLT\OTB100\OTB100\Walking2\img\','startFrame',1,'endFrame',500,'nz',4,'ext','jpg','init_rect', [188,233,370,378]),...
