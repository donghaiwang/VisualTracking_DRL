...
attPath = ['anno' filesep 'att' filesep]; % The folder that contains the annotation files for sequence attributes
...
figPath = ['figs' filesep 'overall' filesep];

perfMatPath = ['perfMat' filesep 'overall' filesep];
